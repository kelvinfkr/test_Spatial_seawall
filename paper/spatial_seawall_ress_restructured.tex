...
\subsection*{Key Modeling Assumption}

Before analyzing the convex chain structure, we state an essential assumption about the pairwise potential:

\begin{boxed}
\textbf{Assumption A (Convex Local Interaction).}
...
\noindent Under Assumption A, all theoretical results below hold.
\end{boxed}
...
Under **Assumption A**, the pairwise potential $\Phi_{i,i+1}(h_i, h_{i+1})$ is jointly convex. The validity of this assumption in extreme-value settings is well-established:
